...
ggplot(rdf,aes(sum))+
  geom_histogram()+
  geom_vline(xintercept=0.06408*12,linetype="dotted")+
  geom_vline(xintercept=0.119797*12,linetype="dotted")+
  geom_vline(xintercept=0.18388*12,linetype="dotted")+
  geom_vline(xintercept=0.25758*12,linetype="dotted")+
  geom_vline(xintercept=0.34236*12,linetype="dotted")+
  geom_vline(xintercept=0.43986*12,linetype="dotted",colour="red",linewidth=1.5)+
  geom_vline(xintercept=0.55201*12,linetype="dotted")+
  geom_vline(xintercept=0.680999*12,linetype="dotted")+
  geom_vline(xintercept=0.82935966*12,linetype="dotted")+
  geom_vline(xintercept=12,linetype="dotted")+
    theme_bw()+xlab("number of layers")

rsum<-rsum/12 # scale to the maximum value (12)
